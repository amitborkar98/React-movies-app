            ...
            <div className="details">
                ...
                <div className="flex-containerDetails">
                    ...
                    <div className="middleDetails">
                        ...
                        <div>
                            <Typography><span className="bold"> Rating:</span> {movie.critics_rating}  
                            </Typography>
                        </div>
                        <div className="marginTop16">
                            <Typography><span className="bold">Plot:</span> <a href={movie.wiki_url}>(Wiki Link)</a> {movie.storyline} 
                            </Typography>
                        </div>
